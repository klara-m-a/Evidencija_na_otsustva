...
export class ServicesService {
  ...
  addVraboten(vraboten: Vraboteni, firma: Firmi, oddel: Oddeli) {
    ...
    return this.http.post('http://localhost/eotsustva/addVraboten.php?f_id=' + firma.f_id + '&oddel_id=' + oddel.oddel_id, vraboten, {responseType: 'text'});
  }
  ...
  addOtsustvo(otsustvo:Otsustva, vraboten: Vraboteni, vid: Vidovi) {
    ...
    return this.http.post('http://localhost/eotsustva/addOtsustvo.php?v_id=' + vraboten.v_id + '&vid_id=' + vid.vid_id, otsustvo, {responseType: 'text'});
  }
}
